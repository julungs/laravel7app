            ...
            <form method="post" action="/customers">
              @csrf
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control @error('phone') is-invalid @enderror" type="text" id="phone" placeholder="e.g.  +6789012345678" name="phone" value="{{old('phone')}}" minlength="12" maxlength="14" required>
                    @error('phone') <div class="invalid-feedback">{{$message}}</div> @enderror
                  </div>
                  <div class="form-group">
                    <label for="email">Email</label>
                    <input class="form-control @error('email') is-invalid @enderror" type="email" id="email" placeholder="e.g.  user@example.com" name="email" value="{{old('email')}}" required>
